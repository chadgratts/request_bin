...
async function seedMongoDB() {
  ...
  try {
    ...
    console.log('Inserted requests document two ID:', resultTwo.insertedId, 'postgres mongo_request_id for POST to jWM187dSQ8xT');
    console.log('Inserted requests document three ID:', resultThree.insertedId, 'postgres mongo_request_id for GET to beLAPhQgY9xM');
  ...
  try {
    ...
    console.log('Inserted bodies document two ID:', resultTwo.insertedId, 'postgres mongo_body_id for POST to jWM187dSQ8xT');
    console.log('Inserted bodies document three ID:', resultThree.insertedId, 'postgres mongo_body_id for GET to beLAPhQgY9xM');
  } catch (err) {
